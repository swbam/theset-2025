        ...
        >
          <div 
            ...
            style={{
              ...
              backgroundColor: !show.image ? 'rgba(255,255,255,0.1)' : undefined,
            }}
          />
          <div className="p-6">
            <h3 className="text-white font-semibold text-lg mb-3 truncate" title={show.artistName}>
              {show.artistName}
            </h3>
            ...
            <div className="flex items-center text-sm text-zinc-400">
              ...
              <span className="truncate" title={`${show.venue}, ${show.location}`}>
                {show.venue && show.location ? `${show.venue}, ${show.location}` : show.venue || show.location}
              </span>
            </div>
          </div>
        </Card>
